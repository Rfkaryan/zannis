...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li><a href="/cart"><i class="fa fa-shopping-cart"></i> <span>3</span></a></li>
            </ul>
            <div class="header__cart__price">item: <span>Rp.1.500.000</span></div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="footer__copyright__payment"><img src="{{asset ('assets/img/payment.png') }}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
